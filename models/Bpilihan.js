...
var Task = {
    getAllTasks: function (callback) {
        return db.query('select * from t_artikel join t_section on t_artikel.id_section = t_section.id_section where t_artikel.hot=? and t_artikel.publish=? order by tgl_pub DESC limit 6', ['Y','Y'], callback);
    }
